...
public class Reaction : MonoBehaviour
{
    ...
    void Update()
    {
        if (water.containsWater == true && metal.containsNatrium == false)
        {
            if (canvasText)
            {
                canvasText.text = "Now you can add Sodium. For this, press twice on the lid with the grip button or a hand pinch, and when the lid has disappeared you can grab the glass.";
            }
