...
public class CaCO3Reaction : MonoBehaviour
{
    ...
    void Update()
    {
        if(balloon.balonPesteEprubeta == true)
        {
            ...
            {
                canvasText.text = "You have successfully attached the balloon! Now you can light the Bunsen burner by pressing the white button on the burner with the grip button or a hand pinch.";
