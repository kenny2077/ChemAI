...
public class ControlReactions : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SetAllExperimentSheetsActive(false);
    }

    private void SetAllExperimentSheetsActive(bool isActive)
    {
        if (experimentSheet1 != null) experimentSheet1.SetActive(isActive);
        if (experimentSheet2 != null) experimentSheet2.SetActive(isActive);
        if (experimentSheet3 != null) experimentSheet3.SetActive(isActive);
        if (experimentSheet4 != null) experimentSheet4.SetActive(isActive);
        if (experimentSheet5 != null) experimentSheet5.SetActive(isActive);
        if (experimentSheet6 != null) experimentSheet6.SetActive(isActive);
        if (experimentSheet7 != null) experimentSheet7.SetActive(isActive);
        if (experimentSheet8 != null) experimentSheet8.SetActive(isActive);
    }
    ...
    public void StartReaction1()
    {
        ...
        canvasText.text = "To create caustic soda, you can start by grabbing the Erlenmeyer beaker of water with the grip button or a hand pinch, and then pour it over the Berzelius beaker.";
    ...
    public void StartReaction2()
    {
        ...
        popupWindow.SetActive(true);
        canvasText.text = "To create copper(II) sulfate (also known as blue vitriol), you can start by grabbing the Erlenmeyer beaker of sulfuric acid with the grip button or a hand pinch, and then pour it over the Berzelius beaker.";
        audioSource_guidance.Stop();
    ...
    public void StartReaction3()
    {
        ...
        popupWindow.SetActive(true);
        canvasText.text = "To create sodium chloride (also known as table salt), you can start by grabbing the Erlenmeyer beaker of hydrochloric acid with the grip button or a hand pinch, and then pour it over the Berzelius beaker.";
        audioSource_guidance.Stop();
    ...
    public void StartReaction4()
    {
        ...
        popupWindow.SetActive(true);
        canvasText.text = "To create potassium hydroxide, you can start by grabbing the Erlenmeyer beaker of water with the grip button or a hand pinch, and then pour it over the Berzelius beaker.";
        audioSource_guidance.Stop();
    ...
    public void StartReaction5()
    {
        ...
        popupWindow.SetActive(true);
        canvasText.text = "To create aluminum iodide, you can start by grabbing the Aluminum beaker with the grip button or a hand pinch, and then pour it over the crystallizing dish.";
        audioSource_guidance.Stop();
    ...
    public void StartReaction6()
    {
        ...
        popupWindow.SetActive(true);
        canvasText.text = "To create calcium hydroxide, you can start by grabbing the Erlenmeyer beaker of water with the grip button or a hand pinch, and then pour it over the Berzelius beaker.";
        audioSource_guidance.Stop();
    ...
    public void StartReaction8()
    {
        ...
        popupWindow.SetActive(true);
        canvasText.text = "To decompose iron sulfate into iron oxide, sulfur dioxide, and sulfur trioxide, you can start by lighting the Bunsen burner by pressing the white button on the burner with the grip button or a hand pinch.";
        audioSource_guidance.Stop();
