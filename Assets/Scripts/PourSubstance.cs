...
public class PourSubstance : MonoBehaviour
{
    ...
    private Material originalSecondGlassMaterial;
    private bool originalSubstanceActive;
    void Start()
    {
        waterLeak.Stop();
        ...
        originalSecondGlassMaterial = secondGlassSubstanceRenderer.material;
        originalSubstanceActive = substance.activeSelf;
    }
    ...
    public void ResetState()
    {
        ...
        if (substance != null)
        {
            substance.SetActive(originalSubstanceActive);
        }

        if (secondGlassSubstanceRenderer != null && originalSecondGlassMaterial != null)
        {
            secondGlassSubstanceRenderer.material = originalSecondGlassMaterial;
        }
    }
}
