...
public class ReactionAli3 : MonoBehaviour
{
    ...
    void Update()
    {
        if(aluminum.containsCuO == true && iodine.containsCuO == false)
        {
            if (canvasText)
            {
                canvasText.text = "Now you can add Iodine. For this, grab the Iodine beaker with the grip button or a hand pinch.";
            }
        ...
        if(aluminum.containsCuO == false && iodine.containsCuO == true)
        {
            if (canvasText)
            {
                canvasText.text = "Now you can add Aluminum. For this, grab the Aluminum beaker with the grip button or a hand pinch.";
            }
        ...
        if(aluminum.containsCuO == true && iodine.containsCuO == true && pipette.containsWater == false)
        {
            if (canvasText)
            {
                canvasText.text = "Now you can add water. For this, grab the pipette with the grip button or a hand pinch, bring it to the mouth of the Water beaker, and pour a few drops over the mixture of Aluminum and Iodine.";
            }
    ...
    public void ResetReactionState()
    {
        ...
        if (firstPowder != null) firstPowder.SetActive(false);
        if (blackPowder != null) blackPowder.SetActive(false);
        if (purplePowder != null) purplePowder.SetActive(false);
        if (whitePowder != null) whitePowder.SetActive(false);

        if (explosionGameObject1 != null) explosionGameObject1.SetActive(false);
        if (explosionGameObject2 != null) explosionGameObject2.SetActive(false);
        if (explosionGameObject3 != null) explosionGameObject3.SetActive(false);
